...
export const serviceExactConfig: Record<string, ServiceExactConfig> = {
  ...
  '/aircond-installation-kl/': {
    ...
    imageAlt: 'Owner-supplied wall-mounted aircond unit used for installation planning',
  ...
  '/upah-pasang-aircond-selangor/': {
    ...
    imageAlt: 'Owner-supplied aircond unit with trunking for a Selangor installation page',
    chips: ['1.0HP & 1.5HP: RM220', '2.0HP & 2.5HP: RM280'],
