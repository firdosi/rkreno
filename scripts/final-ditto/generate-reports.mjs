...
await writeFile(path.join(reports, 'final-ditto-review', 'index.html'), `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>RK Reno final all-page review</title><style>
